...
async function getRunes() {
   const data = await fetch("https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/pt_br/v1/perks.json");
...
async function getRuneStyles() {
   const data = await fetch("https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/pt_br/v1/perkstyles.json");
